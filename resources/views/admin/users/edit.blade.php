<x-admin-dashboard-layout>
    <x-slot name="header">
        Account Management <span class="text-gray-500 text-base font-normal ml-2">Edit User</span>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="glass-panel p-8">
            <div class="flex items-center gap-4 mb-8">
                ...
                <h5 class="font-bold text-xl text-gray-800">Edit User Profile</h5>
            </div>
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="role" required
                        ...
                        <option value="counsellor" {{ old('role', $user->role) == 'counsellor' ? 'selected' : '' }}>
                            Counsellor</option>
                ...
                <div class="pt-4 mt-6 border-t border-gray-100">
                    <h6 class="text-sm font-bold text-gray-800 mb-4">Change Password <span
                            class="text-xs font-normal text-gray-400 ml-2">(Leave blank to keep current password)</span>
                    </h6>

                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <label class="block text-xs font-bold text-gray-600 mb-2">New Password</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-600 mb-2">Confirm New Password</label>
